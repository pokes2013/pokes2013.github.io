...
> 原文地址：https://blog.csdn.net/m0_52775179/article/details/144137766
...
对文件进行打包，默认情况并不会压缩，如果指定了相应的参数，它还会调用相应的压缩程序（如 gzip 和 bzip 等）进行压缩和解压）推荐
